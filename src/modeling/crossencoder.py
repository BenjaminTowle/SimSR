...
from transformers import BertPreTrainedModel, BertModel, BertTokenizer, DistilBertPreTrainedModel, DistilBertModel
...
class DistilBertCrossEncoder(DistilBertPreTrainedModel):
...
class DistilBertBinaryCrossEncoder(DistilBertPreTrainedModel):
